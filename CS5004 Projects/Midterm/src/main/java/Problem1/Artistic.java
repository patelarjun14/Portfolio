...
public class Artistic extends Photographs{

  public Artistic(String name, ArrayList<Name> artistCreator, ArrayList<Name> ownerName, Double askingPrice,
  ...
  public Double calculateStartingBid() {
    return (this.askingPrice)*(1.02 + cameraModelFactor());
  }
}
