...
public class WaterColorPainting extends Paintings{
  ...
  public WaterColorPainting(String name, ArrayList<Name> artistCreator, ArrayList<Name> ownerName,
  ...
  public Double calculateStartingBid() {
    return (this.askingPrice)*(1.02 +photoOwnedFactor() +paintingAuctionFactor());
  }
