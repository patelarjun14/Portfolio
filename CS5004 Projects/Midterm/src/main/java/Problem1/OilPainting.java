...
public class OilPainting extends Paintings {
  ...
  public OilPainting(String name, ArrayList<Name> artistCreator, ArrayList<Name> ownerName, Double askingPrice,
  ...
  public Double calculateStartingBid() {
    return (this.askingPrice)*(1.02 + this.photoOwnedFactor() + paintingAuctionFactor());
  }
