...
class ArtisticTest {
  ...
  void setUp() {
    ...
    testArtistic = new Artistic("Something",testString,testString2,1200.00,"EOS R5","Canon");
  }
  ...
  void cameraModelFactor() {
    assertEquals("Canon",testArtistic.getModel());
  }

  @Test
  void calculateStartingBid() {
    assertEquals(2844,testArtistic.calculateStartingBid());
