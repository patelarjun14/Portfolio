...
class LifestyleTest {
  private Lifestyle testLifestyle;
  ...
  void setUp() {
    ...
    testLifestyle = new Lifestyle("Something",testString,testString2,1200.00,"EOS R5","Canon");
  ...
  void calculateStartingBid() {
    assertEquals(2844,testLifestyle.calculateStartingBid());  }
