...
public class MainSwimmerClass {
  ...
  public static void main(String[] args) {
    ...
    Swimmer swimmerA = new Swimmer("Michael Phelps", nullTimes, nullTimes, nullTimes,freestyleTimes);
    ...
    for(Swimmer swimmer: swimmersMain.swimmers){
      StringBuilder stringToPrint = new StringBuilder(swimmer +
          swimmer.getAverageSwimTime(swimmer.getFreestyle50mTimes()).toString());
    ...
    for(Swimmer swimmer: swimmersMain.swimmers){
      StringBuilder stringToPrint = new StringBuilder(swimmer +
          swimmer.getFastestSwimTime(swimmer.getFreestyle50mTimes()).toString());
      System.out.println(stringToPrint.toString());
    }
    ...
    for (Swimmer swimmer: swimmersMain.swimmers){
      StringBuilder stringToPrint = new StringBuilder(swimmer +
          swimmer.getSlowestSwimTime(swimmer.getFreestyle50mTimes()).toString());
      System.out.println(stringToPrint.toString());
    }
